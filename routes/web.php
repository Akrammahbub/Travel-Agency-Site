...
Route::get('/team-members',[FrontEndController::class,'team_members'])->name('team_members');
Route::get('/team-member/{slug}',[FrontEndController::class,'team_member'])->name('team_member');
...
Route::post('/enquery/submit/{id}',[FrontEndController::class,'enquery_form_submit'])->name('enquery_form_submit');
Route::post('/review/submit',[FrontEndController::class,'review_submit'])->name('review_submit');
Route::get('/wishlist/{package_id}',[FrontEndController::class,'wishlist'])->name('wishlist');
Route::post('/subscriber_submit', [FrontEndController::class, 'subscriber_submit'])->name('subscriber_submit');
Route::get('/subscriber_verify/{email}/{token}', [FrontEndController::class, 'subscriber_verify'])->name('subscriber_verify');
Route::get('/terms-of-use',[FrontEndController::class,'terms'])->name('terms');
Route::get('/privacy-policy',[FrontEndController::class,'privacy'])->name('privacy');

// Payment
Route::post('/payment',[FrontEndController::class,'payment'])->name('payment');

Route::get('/paypal/success', [FrontEndController::class, 'paypal_success'])->name('paypal_success');
Route::get('/paypal/cancel', [FrontEndController::class, 'paypal_cancel'])->name('paypal_cancel');

Route::get('/stripe/success', [FrontEndController::class, 'stripe_success'])->name('stripe_success');
Route::get('/stripe/cancel', [FrontEndController::class, 'stripe_cancel'])->name('stripe_cancel');
...
Route::post('/registration',[FrontEndController::class,'registration_submit'])->name('registration_submit');
...
Route::post('/forget-password',[FrontEndController::class,'forget_password_submit'])->name('forget_password_submit');
Route::get('/reset-password/{token}/{email}',[FrontEndController::class,'reset_password'])->name('reset_password');
Route::post('/reset-password/{token}/{email}',[FrontEndController::class,'reset_password_submit'])->name('reset_password_submit');
