                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="item pb_25">
                            <div class="photo">
                                <a href="{{route('package')}}"><img src="uploads/package-1.jpg" alt=""></a>
                                <div class="wishlist">
                            ...
                            <div class="text">
                                ...
                                <h2>
                                    <a href="{{route('package')}}">Venice Grand Canal</a>
                                </h2>
                                <div class="review">
                                    <i class="fas fa-star"></i>
                                    <i class="fas fa-star"></i>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="item pb_25">
                            <div class="photo">
                                <a href="{{route('package')}}"><img src="uploads/package-2.jpg" alt=""></a>
                                <div class="wishlist">
                                    <a href=""><i class="far fa-heart"></i></a>
                                </div>
                            </div>
                            <div class="text">
                                ...
                                <h2>
                                    <a href="{{route('package')}}">Great Barrier Reef</a>
                                </h2>
                                <div class="review">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="item pb_25">
                            <div class="photo">
                                <a href="{{route('package')}}"><img src="uploads/package-3.jpg" alt=""></a>
                                <div class="wishlist">
                                    <a href=""><i class="far fa-heart"></i></a>
                                </div>
                            </div>
                            <div class="text">
                                ...
                                <h2>
                                    <a href="{{route('package')}}">Similan Islands, Andaman Sea</a>
                                </h2>
                                <div class="review">
                                    <i class="fas fa-star"></i>
                                    <i class="fas fa-star"></i>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="item pb_25">
                            <div class="photo">
                                <a href="{{route('package')}}"><img src="uploads/package-4.jpg" alt=""></a>
                                <div class="wishlist">
                                    <a href=""><i class="far fa-heart"></i></a>
                                </div>
                            </div>
                            <div class="text">
                                ...
                                <h2>
                                    <a href="{{route('package')}}">Royal Ontario Museum</a>
                                </h2>
                                <div class="review">
                                    <i class="fas fa-star"></i>
                                    <i class="fas fa-star"></i>
